    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if (ourAnimals[i, 2] == "Age: " || ourAnimals[i, 2] == "Age: ?" || ourAnimals[i, 2].Substring(5, 1) == "-")
                    {
                        Console.WriteLine($"We need to update the age for\n{ourAnimals[i, 1]}\n{ourAnimals[i, 3]}\n{ourAnimals[i, 2]}");
                        validEntry = false;
                        do
                        {
                    ...
                    {
                        Console.WriteLine($"We need to update its physical description too\n{ourAnimals[i, 4]}");
                        do
                        {
                            Console.WriteLine("Enter a physical description of the pet (size, color, gender, weight, housebroken)");
                            readResult = Console.ReadLine();
                        ...
                        } while (animalPhysicalDescription.Trim() == "" || animalPhysicalDescription == "tbd");
                        ourAnimals[i, 4] = "Physical description: " + animalPhysicalDescription;
                    }
                }
            }
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    {
                        Console.WriteLine($"We need to update its nickname\n{ourAnimals[i, 1]}\n{ourAnimals[i, 0]}\n{ourAnimals[i, 3]}");
                        do
                        {
                            Console.WriteLine("Enter the nickname for the pet");
                            readResult = Console.ReadLine();
                            if (readResult != null)
                            {
                                animalNickname = readResult.ToLower();
                            }
                        } while (animalNickname.Trim() == "" || animalNickname == "tbd");
                        ourAnimals[i, 4] = "Nickname: " + animalNickname;
                    }
                    if (ourAnimals[i, 5] == "Personality: " || ourAnimals[i, 5] == "Personality: tbd")
                    {
                        Console.WriteLine($"We need to update its personality too\n{ourAnimals[i, 5]}");
                        do
                        {
                            Console.WriteLine("Enter the description of the pet's personality (likes or dislikes, tricks, energy level)");
                            readResult = Console.ReadLine();
                            if (readResult != null)
                            {
                                animalPersonalityDescription = readResult.ToLower();
                            }
                        } while (animalPersonalityDescription.Trim() == "" || animalPersonalityDescription == "tbd");
                        ourAnimals[i, 5] = "Personality: " + animalPersonalityDescription;
                    }
                }
            }
            Console.WriteLine("All animal nicknames and personality descriptions are complete!\nPress the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
